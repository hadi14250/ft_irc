...
<a href="https://github.com/hadi14250">
    <img src="github_gifs/client-server.gif" alt="client server gif" width="150" height="150">
  </a>
...
- Written from scratch in **C++** with no external networking libraries
- Non-blocking sockets multiplexed with **`poll`** for concurrent clients
- Compatible with standard IRC clients such as **irssi**
- Full channel support: invites, kicks, modes, topics, and operator privileges
- Clean separation between server, client, and channel logic
...
<tr>
    <td align="center" style="word-wrap: break-word; width: 150.0; height: 150.0">
        <a href=https://github.com/hadi14250>
            <img src="https://avatars.githubusercontent.com/u/93770645?v=4" width="100;"  style="border-radius:50%;align-items:center;justify-content:center;overflow:hidden;padding-top:10px" alt=Hadi Kaddoura/>
            <br />
    ...
    <td align="center" style="word-wrap: break-word; width: 150.0; height: 150.0">
        ...
        <a href=https://github.com/virtualjensen>
            <img src="https://avatars.githubusercontent.com/u/94916561?v=4" width="100;"  style="border-radius:50%;align-items:center;justify-content:center;overflow:hidden;padding-top:10px" alt=Jensen/>
            <br />
